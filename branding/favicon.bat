...
set PNG_EXISTS=0
set SVG_EXISTS=0
if exist "source\favicon.png" set PNG_EXISTS=1
if exist "source\favicon.svg" set SVG_EXISTS=1
...
:validate_format
if "%SOURCE_FORMAT%"=="" (
    if exist "source\favicon.svg" (
        set SOURCE_FORMAT=svg
    ) else if exist "source\favicon.png" (
        set SOURCE_FORMAT=png
    )
)
...
set SOURCE_FILE=source\favicon.%SOURCE_FORMAT%
